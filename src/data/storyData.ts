...
const careerRoute: StoryRoute = {
  ...
  stages: [
    ...
    },
    {
      ...
      title: "登堂入室",
      narrative: [
        "你的威名传遍了整片大陆。各方势力纷纷遣使来访，邀请你加入更大的舞台。",
        "一座悬浮在云端之上的传奇城池出现在天际。那里汇聚了当世最顶尖的人物——最伟大的商人、最博学的学者、最传奇的工匠。",
        "城门上刻着一句话：\"此处乃天下之巅，得之则可主宰乾坤。\"骏马仰首望向云端，眼神中既有期待也有担忧。",
        "然而要进入这座城池，你需要通过三道考验……",
      ],
      choices: [
        { id: "c5a", emoji: "⚖️", title: "诚信之道", description: "以诚待人，信守承诺", tag: "诚信" },
        { id: "c5b", emoji: "🎯", title: "精准之道", description: "洞察秋毫，一击即中", tag: "精准" },
        { id: "c5c", emoji: "🤲", title: "共赢之道", description: "互利互惠，共创繁荣", tag: "共赢" },
      ],
    },
    {
      id: "c6",
      title: "问鼎天下",
      narrative: [
        "经过重重考验，你终于站在了传奇城池的最高处。俯瞰众生，万里山河尽收眼底。",
        "曾经的困难与挑战，都化作了脚下的基石。骏马已成长为真正的神驹，周身散发着金色光芒。",
        "忽然，天空中降下一道绚烂的霞光，一位老者出现在你面前：\"少年，你已证明了自己的实力。如今，你愿意承担更大的责任吗？\"",
        "你的选择将决定这个世界的未来……",
      ],
      choices: [
        { id: "c6a", emoji: "🏛️", title: "定鼎之功", description: "建立一个新的秩序，造福万民", tag: "领袖" },
        { id: "c6b", emoji: "📚", title: "传承之道", description: "将智慧与经验传授给后人", tag: "传承" },
        { id: "c6c", emoji: "🌉", title: "归隐之志", description: "事了拂衣去，深藏功与名", tag: "超脱" },
      ],
    },
  ],
};
...
const loveRoute: StoryRoute = {
  ...
  stages: [
    ...
    },
    {
      ...
      title: "缘定三生",
      narrative: [
        "你来到一座古老的月老庙。红线缠绕的姻缘树上挂满了无数有情人的名字。",
        "庙中的老月老缓缓睁开双眼：\"有情人终成眷属，但真正的缘分，需要历经三生三世的考验。\"",
        "忽然，庙门大开，一条铺满花瓣的道路伸向远方。路的尽头，隐约可见三个不同的身影。",
        "骏马轻声嘶鸣，仿佛在提醒你：这一次的选择，将决定永恒……",
      ],
      choices: [
        { id: "l5a", emoji: "🌸", title: "初见倾心", description: "那一瞬的心动，足以温暖一生", tag: "心动" },
        { id: "l5b", emoji: "💫", title: "再续前缘", description: "无论轮回多久，我都会找到你", tag: "坚守" },
        { id: "l5c", emoji: "🕊️", title: "放手成全", description: "真正的爱，是让对方幸福", tag: "成全" },
      ],
    },
    {
      id: "l6",
      title: "永恒誓言",
      narrative: [
        "星光洒满夜空，你和心爱之人并肩站在银河之下。流星划过，留下绚烂的痕迹。",
        "骏马轻轻走到你们身旁，鼻尖触碰着你们的衣角，仿佛在送上最真挚的祝福。",
        "\"愿我如星君如月，夜夜流光相皎洁。\"你轻声吟诵，握住她的手。",
        "天地为证，星辰为鉴。在这个美好的夜晚，你们许下了永恒的誓言……",
      ],
      choices: [
        { id: "l6a", emoji: "💎", title: "海枯石烂", description: "无论发生什么，我永远在你身边", tag: "承诺" },
        { id: "l6b", emoji: "🌅", title: "相濡以沫", description: "一起慢慢变老，看遍世间风景", tag: "陪伴" },
        { id: "l6c", emoji: "🎶", title: "琴瑟和鸣", description: "的灵魂伴侣，永远心意相通", tag: "知己" },
      ],
    },
  ],
};
...
const selfRoute: StoryRoute = {
  ...
  stages: [
    ...
    },
    {
      ...
      title: "智慧传承",
      narrative: [
        "星辰的力量在你体内流淌。你发现自己来到了一座古老的书院，这里汇聚了千古圣贤的智慧。",
        "书架上摆满了竹简、帛书、纸张……每一本都承载着前人的心血与结晶。",
        "一位白发飘飘的老者向你走来：\"年轻人，你已找到了自己的道。但一个人的智慧终究有限，你想把这些智慧传承下去吗？\"",
        "骏马安静地趴在你脚边，等待着你的答案……",
      ],
      choices: [
        { id: "s5a", emoji: "📜", title: "著书立说", description: "将所学编撰成书，惠及后人", tag: "著作" },
        { id: "s5b", emoji: "🎓", title: "开坛讲学", description: "口耳相传，直接教导学生", tag: "教育" },
        { id: "s5c", emoji: "🌱", title: "身体力行", description: "以身作则，用行动影响世界", tag: "践行" },
      ],
    },
    {
      id: "s6",
      title: "回归本源",
      narrative: [
        "你骑着骏马回到了最初的起点——那片晨光中的草原。一切仿佛都没有改变，但又似乎完全不同了。",
        "当初的那匹骏马，现在已浑身散发着金色的光芒，成为了真正的神驹。它见证了你这一路的成长。",
        "\"大道至简，返璞归真。\"你终于明白，最高的智慧，往往藏在最简单的事物之中。",
        "当你再次睁开眼，世界已焕然一新。新年的钟声敲响，你带着满满的祝福，准备迎接全新的旅程……",
      ],
      choices: [
        { id: "s6a", emoji: "☀️", title: "重新出发", description: "带着智慧与祝福，迎接新的开始", tag: "新生" },
        { id: "s6b", emoji: "🌀", title: "轮回转世", description: "化作星光，继续守护这个世界", tag: "守护" },
        { id: "s6c", emoji: "🎭", title: "游戏人间", description: "以轻松的心态，体验人生的百态", tag: "逍遥" },
      ],
    },
  ],
};
